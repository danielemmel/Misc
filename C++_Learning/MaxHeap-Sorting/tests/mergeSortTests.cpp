...
TEST(mergeSortTest, TestEmpty) {
    Vec v = {};
    auto v_copy = v;
    v = mergeSort(v, true);
    v_copy = mergeSort(v_copy, false);
    ASSERT_TRUE(v.empty());
...
TEST(mergeSortTest, TestDuplicates) {
...
TEST(mergeSortTest, TestSortedReverse) {
