...
TEST(BubbleSortTest, TestEmpty) {
    Vec v = {};
    auto v_copy = v;
    bubbleSort(v, true);
    bubbleSort(v_copy, false);
    ASSERT_TRUE(v.empty());
    ASSERT_TRUE(v_copy.empty());
}

TEST(BubbleSortTest, TestOneElement) {
    Vec v = {42};
    auto v_copy = v;
    bubbleSort(v, true);
    bubbleSort(v_copy, false);
...
TEST(BubbleSortTest, TestDuplicates) {
...
TEST(BubbleSortTest, TestSorted) {
...
TEST(BubbleSortTest, TestSortedReverse) {
